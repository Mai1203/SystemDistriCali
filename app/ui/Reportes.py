...
"")
        ...
        self.gridLayout.addWidget(self.label, 0, 0, 1, 1, QtCore.Qt.AlignmentFlag.AlignLeft|QtCore.Qt.AlignmentFlag.AlignTop)
        ...
        self.gridLayout.addWidget(self.label_2, 1, 0, 1, 1, QtCore.Qt.AlignmentFlag.AlignLeft)
        ...
        self.gridLayout.addWidget(self.CalendarioCaja, 7, 0, 1, 1, QtCore.Qt.AlignmentFlag.AlignHCenter|QtCore.Qt.AlignmentFlag.AlignTop)
        ...
        self.BtnTicketCaja.setCursor(QtGui.QCursor(QtCore.Qt.CursorShape.PointingHandCursor))
...
"}")
        ...
        self.gridLayout.addWidget(self.BtnTicketCaja, 8, 0, 1, 1, QtCore.Qt.AlignmentFlag.AlignHCenter)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.TipoCajaComboBox.sizePolicy().hasHeightForWidth())
        self.TipoCajaComboBox.setSizePolicy(sizePolicy)
        self.TipoCajaComboBox.setMinimumSize(QtCore.QSize(250, 50))
        self.TipoCajaComboBox.setStyleSheet("QComboBox {\n"
"    background-color: white; /* Fondo blanco */\n"
...
"")
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.TiempoCajaComboBox.sizePolicy().hasHeightForWidth())
        self.TiempoCajaComboBox.setSizePolicy(sizePolicy)
        self.TiempoCajaComboBox.setMinimumSize(QtCore.QSize(250, 50))
        self.TiempoCajaComboBox.setStyleSheet("QComboBox {\n"
"    background-color: white; /* Fondo blanco */\n"
"    border: none; /* Sin borde */\n"
"    color: black; /* Color del texto */\n"
"    border-radius: 15px; /* Bordes redondeados */\n"
...
"")
        ...
        self.gridLayout_3.addWidget(self.label_5, 0, 0, 1, 1, QtCore.Qt.AlignmentFlag.AlignHCenter)
        ...
        self.BtnTicketProducto.setCursor(QtGui.QCursor(QtCore.Qt.CursorShape.PointingHandCursor))
...
"}")
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.TipoProductosComboBox.sizePolicy().hasHeightForWidth())
        self.TipoProductosComboBox.setSizePolicy(sizePolicy)
        self.TipoProductosComboBox.setMinimumSize(QtCore.QSize(250, 50))
        self.TipoProductosComboBox.setStyleSheet("QComboBox {\n"
"    background-color: white; /* Fondo blanco */\n"
"    border: none; /* Sin borde */\n"
"    color: black; /* Color del texto */\n"
"    border-radius: 15px; /* Bordes redondeados */\n"
...
"")
        ...
        self.gridLayout_3.addWidget(self.TipoProductosComboBox, 1, 0, 1, 1, QtCore.Qt.AlignmentFlag.AlignHCenter)
        ...
        self.BtnTicketAnalisis.setCursor(QtGui.QCursor(QtCore.Qt.CursorShape.PointingHandCursor))
...
"}")
        ...
        self.gridLayout_4.addWidget(self.BtnTicketAnalisis, 6, 0, 1, 1, QtCore.Qt.AlignmentFlag.AlignVCenter)
...
"")
        ...
        self.gridLayout_4.addWidget(self.label_6, 0, 0, 1, 1, QtCore.Qt.AlignmentFlag.AlignLeft)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.ReporteAnalisisComboBox.sizePolicy().hasHeightForWidth())
        self.ReporteAnalisisComboBox.setSizePolicy(sizePolicy)
        self.ReporteAnalisisComboBox.setMinimumSize(QtCore.QSize(250, 50))
        self.ReporteAnalisisComboBox.setStyleSheet("QComboBox {\n"
"    background-color: white; /* Fondo blanco */\n"
"    border: none; /* Sin borde */\n"
"    color: black; /* Color del texto */\n"
"    border-radius: 15px; /* Bordes redondeados */\n"
...
"")
        ...
        self.gridLayout_4.addWidget(self.CalendarioAnalisis, 5, 0, 1, 1, QtCore.Qt.AlignmentFlag.AlignHCenter|QtCore.Qt.AlignmentFlag.AlignVCenter)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.TiempoAnalisisComboBox.sizePolicy().hasHeightForWidth())
        self.TiempoAnalisisComboBox.setSizePolicy(sizePolicy)
        self.TiempoAnalisisComboBox.setMinimumSize(QtCore.QSize(250, 50))
        self.TiempoAnalisisComboBox.setStyleSheet("QComboBox {\n"
"    background-color: white; /* Fondo blanco */\n"
"    border: none; /* Sin borde */\n"
"    color: black; /* Color del texto */\n"
"    border-radius: 15px; /* Bordes redondeados */\n"
