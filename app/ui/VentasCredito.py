...
"")
        ...
        self.comboBoxPrecio = QtWidgets.QComboBox(parent=self.widget_3)
...
"")
        ...
        self.InputPrecioUnitario.setMinimumSize(QtCore.QSize(200, 40))
        self.InputPrecioUnitario.setMaximumSize(QtCore.QSize(200, 40))
        ...
        self.InputCantidad.setMinimumSize(QtCore.QSize(200, 40))
        self.InputCantidad.setMaximumSize(QtCore.QSize(200, 40))
        ...
        self.InputMarca.setMinimumSize(QtCore.QSize(200, 40))
        self.InputMarca.setMaximumSize(QtCore.QSize(200, 40))
        ...
        self.InputNombre.setMinimumSize(QtCore.QSize(200, 40))
        self.InputNombre.setMaximumSize(QtCore.QSize(200, 40))
        ...
        self.InputCodigo.setMinimumSize(QtCore.QSize(200, 40))
        self.InputCodigo.setMaximumSize(QtCore.QSize(200, 40))
        ...
        self.TablaVentasCredito.setMinimumSize(QtCore.QSize(800, 250))
        font = QtGui.QFont()
...
"")
        ...
        self.InputCedula.setMinimumSize(QtCore.QSize(200, 40))
        self.InputCedula.setMaximumSize(QtCore.QSize(200, 40))
        ...
        self.LabelSubtotal.setMinimumSize(QtCore.QSize(200, 40))
        self.LabelSubtotal.setMaximumSize(QtCore.QSize(200, 40))
        ...
        self.InputDireccion.setMinimumSize(QtCore.QSize(200, 40))
        self.InputDireccion.setMaximumSize(QtCore.QSize(200, 40))
        ...
        self.InputNombreCli.setMinimumSize(QtCore.QSize(200, 40))
        self.InputNombreCli.setMaximumSize(QtCore.QSize(200, 40))
        ...
        self.LimitePagoBox.setMinimumSize(QtCore.QSize(200, 40))
...
"}")
        ...
        self.InputApellidoCli.setMinimumSize(QtCore.QSize(200, 40))
        self.InputApellidoCli.setMaximumSize(QtCore.QSize(200, 40))
        ...
        self.InputTelefonoCli.setMinimumSize(QtCore.QSize(200, 40))
        self.InputTelefonoCli.setMaximumSize(QtCore.QSize(200, 40))
        ...
        self.LabelTotal.setMinimumSize(QtCore.QSize(200, 40))
        self.LabelTotal.setMaximumSize(QtCore.QSize(200, 40))
        ...
        self.InputDomicilio = QtWidgets.QLineEdit(parent=self.widget_4)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.InputDomicilio.setMinimumSize(QtCore.QSize(200, 40))
        self.InputDomicilio.setMaximumSize(QtCore.QSize(200, 40))
