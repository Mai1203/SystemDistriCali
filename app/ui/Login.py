...
class Ui_Login(object):
    def setupUi(self, CONTENEDEDOR1):
        ...
        self.CONTENEDOR2 = QtWidgets.QWidget(parent=CONTENEDEDOR1)
        ...
        self.CONTENEDOR3 = QtWidgets.QWidget(parent=self.CONTENEDOR2)
        self.CONTENEDOR3.setMinimumSize(QtCore.QSize(200, 0))
        self.CONTENEDOR3.setMaximumSize(QtCore.QSize(540, 1000))
        self.CONTENEDOR3.setCursor(QtGui.QCursor(QtCore.Qt.CursorShape.ArrowCursor))
        self.CONTENEDOR3.setContextMenuPolicy(QtCore.Qt.ContextMenuPolicy.ActionsContextMenu)
        self.CONTENEDOR3.setLayoutDirection(QtCore.Qt.LayoutDirection.LeftToRight)
        ...
        self.widget_4 = QtWidgets.QWidget(parent=self.CONTENEDOR3)
        ...
        self.BtnLogin = QtWidgets.QPushButton(parent=self.widget_4)
...
"")
        ...
        self.IMAGEN = QtWidgets.QLabel(parent=self.CONTENEDOR3)
        ...
        self.IMAGEN.setLayoutDirection(QtCore.Qt.LayoutDirection.LeftToRight)
        ...
        self.widget_3 = QtWidgets.QWidget(parent=self.CONTENEDOR3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.BtnRol = QtWidgets.QPushButton(parent=self.widget_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        ...
        self.BtnRol.setCursor(QtGui.QCursor(QtCore.Qt.CursorShape.PointingHandCursor))
        self.BtnRol.setContextMenuPolicy(QtCore.Qt.ContextMenuPolicy.ActionsContextMenu)
        self.BtnRol.setLayoutDirection(QtCore.Qt.LayoutDirection.LeftToRight)
...
"")
        ...
        self.widget_2 = QtWidgets.QWidget(parent=self.CONTENEDOR3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.InputNombreUsuario = QtWidgets.QLineEdit(parent=self.widget_2)
...
"}")
        ...
        self.widget = QtWidgets.QWidget(parent=self.CONTENEDOR3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.InputPassword = QtWidgets.QLineEdit(parent=self.widget)
...
"")
        ...
        self.InputPassword.setAlignment(QtCore.Qt.AlignmentFlag.AlignLeading|QtCore.Qt.AlignmentFlag.AlignLeft|QtCore.Qt.AlignmentFlag.AlignVCenter)
        self.InputPassword.setObjectName("InputPassword")
        self.horizontalLayout_2.addWidget(self.InputPassword, 0, QtCore.Qt.AlignmentFlag.AlignLeft)
...
"")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("assets/iconos/ojo_cerrado.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
