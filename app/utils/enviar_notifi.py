...
class Mensajes(QMessageBox):
    """
    Mantiene compatibilidad para preguntas/confirmaciones modales
    (ej: QMessageBox.question).
    """
    ...
    def question(
        ...
        boton_predeterminado=QMessageBox.StandardButton.No
    ):
        return Mensajes._mostrar(
            parent,
            titulo,
...
class ToastNotification(QWidget):
    ...
    def _setup_ui(
        ...
        layout_texto.setContentsMargins(
            0,
            0,
            0,
            0
    ...
    def _posicionar(self):
        ...
        # QDesktopWidget fue eliminado en Qt6.
        # Usamos el screen disponible de Qt6.
        pantalla = (
            self.screen()
        ...
        index = (
            len(
                ToastNotification._instancias_activas
            ) - 1
        )

        offset_y = index * (
            self.sizeHint().height() + 8
        )
    ...
    def closeEvent(self, event):
        ...
        if self in ToastNotification._instancias_activas:
            ...
            ToastNotification._instancias_activas.remove(
                self
            )
...
def enviar_notificacion(
    ...
    if "error" in titulo_norm:
        ...
        "advertencia" in titulo_norm
        or "warning" in titulo_norm
    ):
